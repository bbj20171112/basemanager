package com.bbj.controller.base.responseconverter;
...
import com.bbj.bizlogic.base.domain.BBJResponse;
 ...
 * @since 4.1
 */
public abstract class AbstractBBJMappingJackson2HttpMessageConverter extends AbstractGenericHttpMessageConverter<Object>{
	...
	protected AbstractBBJMappingJackson2HttpMessageConverter(ObjectMapper objectMapper) {
		init(objectMapper);
	}

	protected AbstractBBJMappingJackson2HttpMessageConverter(ObjectMapper objectMapper, MediaType supportedMediaType) {
		super(supportedMediaType);
		init(objectMapper);
	}

	protected AbstractBBJMappingJackson2HttpMessageConverter(ObjectMapper objectMapper, MediaType... supportedMediaTypes) {
	...
	protected void writeInternal(Object object, Type type, HttpOutputMessage outputMessage)
		...
		object = new BBJResponse("1", object);
